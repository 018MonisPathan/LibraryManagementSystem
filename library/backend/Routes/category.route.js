...
router.get('/countTotalActiveCategories',[auth],CategoryController.countTotalActiveCategories);
router.get('/countTotalDeactiveCategories',[auth],CategoryController.countTotalDeactiveCategories);
